...
class SwipeToDeleteTransaction extends StatefulWidget {
  ...
  @override
  State<SwipeToDeleteTransaction> createState() =>
...
class _SwipeToDeleteTransactionState extends State<SwipeToDeleteTransaction>
  ...
  void _onHorizontalDragEnd(DragEndDetails details, double screenWidth) {
    ...
    if (_dragExtent.abs() > screenWidth * 0.4) {
      ...
      _dragAnimation = Tween<double>(begin: _dragExtent, end: 0.0).animate(
        CurvedAnimation(parent: _dragController, curve: Curves.easeOut),
      );
                  ...
                  child: Container(
                    ...
                    child: Transform.scale(
                      ...
                      child: AnimatedOpacity(
                        ...
                        opacity: _isDismissed
                            ? 0.0
                            : 1.0, // تخفي الأيقونة عند التمرير الكامل
                        child: const Icon(
